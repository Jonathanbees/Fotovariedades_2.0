...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('PENDING', 'PAID', 'FAILED', 'REDEEMED', 'CANCELLED', name='orderstatus'), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'APPROVED', 'DECLINED', 'VOIDED', 'ERROR', name='paymentstatus'), nullable=False),
    sa.Column('payment_method', sa.Enum('CARD', 'NEQUI', 'PSE', 'BANCOLOMBIA_TRANSFER', 'BANCOLOMBIA_COLLECT', name='paymentmethod'), nullable=True),
