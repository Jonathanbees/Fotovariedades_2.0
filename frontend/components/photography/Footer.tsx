...
const Footer: React.FC = () => {
    return (
        <footer className="bg-background-light dark:bg-black py-8 border-t border-gray-200 dark:border-gray-800 relative z-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
                <div className="mb-4 md:mb-0">
                    <span className="text-lg font-bold text-gray-900 dark:text-white">Fotovariedades la 68</span>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">© 2023 Todos los derechos reservados.</p>
                </div>
