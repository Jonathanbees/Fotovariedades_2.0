...
const Header: React.FC = () => {
  return (
    <nav
        className="sticky top-0 z-50 bg-surface-light/90 dark:bg-surface-dark/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-700 shadow-sm">
        <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between gap-4">
                <a className="flex items-center gap-2 group" href="#">
                    <span
                        className="material-icons-outlined text-4xl text-primary group-hover:animate-spin">local_florist</span>
                    <div className="flex flex-col">
                        <span
                            className="text-xl md:text-2xl font-bold brand-gradient-text leading-tight">Fotovariedades</span>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <button className="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700 transition relative">
                        ...
                        <span
                            className="absolute top-0 right-0 w-4 h-4 bg-secondary text-white text-[10px] flex items-center justify-center rounded-full">3</span>
                    </button>
