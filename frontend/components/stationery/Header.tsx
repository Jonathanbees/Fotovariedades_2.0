        ...
        <div className="flex justify-between items-center h-20">
          <div className="shrink-0 flex items-center gap-2">
            ...
            <div className="flex flex-col">
              <span className="font-display text-2xl font-bold logo-gradient leading-tight">
                Variedades la 68
              </span>
          ...
          <div className="hidden md:flex flex-1 max-w-lg mx-8">
            <div className="relative w-full">
              <input
                className="w-full bg-gray-100 dark:bg-gray-800 border-none rounded-full py-2 pl-4 pr-10 focus:ring-2 focus:ring-primary text-sm dark:text-white"
                placeholder="Buscar cuadernos, lapiceros, fotos..."
                type="text"
              />
